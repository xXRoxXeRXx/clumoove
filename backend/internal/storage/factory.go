...
var managerCapabilityRegistry = map[string]ManagerCapabilities{
	...
	"smb":          {Browse: true, Download: true, Archive: true, Upload: true, Mkdir: true, Rename: true, Move: true, Copy: true, DeleteFile: true, DeleteEmptyDirectory: true, DeleteRecursiveDirectory: true, ConflictSkip: true, ConflictOverwrite: true, ConflictOverwriteAtomic: true, ConflictRename: true},
	...
	"sftp":         {Browse: true, Download: true, Archive: true, Upload: true, Mkdir: true, Rename: true, Move: true, Copy: true, DeleteFile: true, DeleteEmptyDirectory: true, DeleteRecursiveDirectory: true, ConflictSkip: true, ConflictOverwrite: true, ConflictOverwriteAtomic: true, ConflictRename: true},
	"ftp":          {Browse: true, Download: true, Archive: true, Upload: true, Mkdir: true, Rename: true, Move: true, Copy: true, DeleteFile: true, DeleteEmptyDirectory: true, DeleteRecursiveDirectory: true, ConflictSkip: true, ConflictOverwrite: true, ConflictOverwriteAtomic: true, ConflictRename: true},
	...
	"local":        {Browse: true, Download: true, Archive: true, Upload: true, Mkdir: true, Rename: true, Move: true, Copy: true, DeleteFile: true, DeleteEmptyDirectory: true, DeleteRecursiveDirectory: true, ConflictSkip: true, ConflictOverwrite: true, ConflictOverwriteAtomic: true, ConflictRename: true},
