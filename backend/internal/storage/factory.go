...
var managerCapabilityRegistry = map[string]ManagerCapabilities{
	"nextcloud":    {Browse: true, NativePagination: true, Download: true, Upload: true, Mkdir: true, Rename: true, Move: true, DeleteFile: true, DeleteEmptyDirectory: true, DeleteRecursiveDirectory: true, ConflictSkip: true, ConflictOverwrite: true, ConflictOverwriteAtomic: true, ConflictRename: true, Thumbnails: true},
	"opencloud":    {Browse: true, Download: true, Upload: true, Mkdir: true, Rename: true, Move: true, DeleteFile: true, DeleteEmptyDirectory: true, DeleteRecursiveDirectory: true, ConflictSkip: true, ConflictOverwrite: true, ConflictOverwriteAtomic: true, ConflictRename: true, Thumbnails: false},
	"webdav":       {Browse: true, Download: true, Upload: true, Mkdir: true, Rename: true, Move: true, DeleteFile: true, DeleteEmptyDirectory: true, DeleteRecursiveDirectory: true, ConflictSkip: true, ConflictOverwrite: true, ConflictOverwriteAtomic: true, ConflictRename: true},
	"dropbox":      {Browse: true, NativePagination: true, Download: true, Upload: true, Mkdir: true, Rename: true, Move: true, DeleteFile: true, DeleteEmptyDirectory: true, DeleteRecursiveDirectory: true, ConflictSkip: true, ConflictOverwrite: true, ConflictOverwriteAtomic: true, ConflictRename: true, Thumbnails: true},
	...
	"onedrive":     {Browse: true, NativePagination: true, Download: true, Upload: true, Mkdir: true, Rename: true, Move: true, DeleteFile: true, DeleteEmptyDirectory: true, DeleteRecursiveDirectory: true, ConflictSkip: true, ConflictOverwrite: true, ConflictOverwriteAtomic: true, ConflictRename: true, Thumbnails: true},
	"hidrive":      {Browse: true, NativePagination: true, Download: true, Upload: true, Mkdir: true, Rename: true, Move: true, DeleteFile: true, DeleteEmptyDirectory: true, DeleteRecursiveDirectory: true, ConflictSkip: true, ConflictOverwrite: true, ConflictOverwriteAtomic: true, ConflictRename: true, Thumbnails: true},
	...
	"magentacloud": {Browse: true, Download: true, Upload: true, Mkdir: true, Rename: true, Move: true, DeleteFile: true, DeleteEmptyDirectory: true, DeleteRecursiveDirectory: true, ConflictSkip: true, ConflictOverwrite: true, ConflictOverwriteAtomic: true, ConflictRename: true, Thumbnails: true},
	"koofr":        {Browse: true, Download: true, Upload: true, Mkdir: true, Rename: true, Move: true, DeleteFile: true, DeleteEmptyDirectory: true, DeleteRecursiveDirectory: true, ConflictSkip: true, ConflictOverwrite: true, ConflictOverwriteAtomic: false, ConflictRename: true, Thumbnails: true},
	...
	"mega":         {Browse: true, Download: true, Upload: true, Mkdir: true, Rename: true, Move: true, DeleteFile: true, DeleteEmptyDirectory: true, DeleteRecursiveDirectory: true, ConflictSkip: true, ConflictOverwrite: true, ConflictOverwriteAtomic: true, ConflictRename: true},
}
