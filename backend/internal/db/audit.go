...
const (
	...
	AuditProfileCreated           AuditAction = "PROFILE_CREATED"
	AuditProfileUpdated           AuditAction = "PROFILE_UPDATED"
	AuditProfileDeleted           AuditAction = "PROFILE_DELETED"
	...
	AuditBackupStarted            AuditAction = "BACKUP_STARTED"
	AuditBackupPaused             AuditAction = "BACKUP_PAUSED"
	AuditBackupResumed            AuditAction = "BACKUP_RESUMED"
	AuditBackupDeleted            AuditAction = "BACKUP_DELETED"
	AuditRestorePreviewCreated    AuditAction = "RESTORE_PREVIEW_CREATED"
	AuditRestorePreviewReady      AuditAction = "RESTORE_PREVIEW_READY"
	AuditRestorePreviewFailed     AuditAction = "RESTORE_PREVIEW_FAILED"
	AuditRestorePreviewCancelled  AuditAction = "RESTORE_PREVIEW_CANCELLED"
	AuditRestorePreviewExpired    AuditAction = "RESTORE_PREVIEW_EXPIRED"
	AuditRestoreCreated           AuditAction = "RESTORE_CREATED"
	AuditRestoreStarted           AuditAction = "RESTORE_STARTED"
	AuditRestoreCompleted         AuditAction = "RESTORE_COMPLETED"
	AuditRestorePartial           AuditAction = "RESTORE_PARTIAL"
	AuditRestoreFailed            AuditAction = "RESTORE_FAILED"
	AuditRestoreCancelled         AuditAction = "RESTORE_CANCELLED"
	AuditRestoreDeleted           AuditAction = "RESTORE_DELETED"
	AuditRestoreRecovered         AuditAction = "RESTORE_RECOVERED"
	AuditRepositoryCheckCreated   AuditAction = "REPOSITORY_CHECK_CREATED"
	AuditRepositoryCheckCompleted AuditAction = "REPOSITORY_CHECK_COMPLETED"
	AuditRepositoryCheckFailed    AuditAction = "REPOSITORY_CHECK_FAILED"
	AuditRepositoryCheckCancelled AuditAction = "REPOSITORY_CHECK_CANCELLED"
	AuditRepositoryCheckRecovered AuditAction = "REPOSITORY_CHECK_RECOVERED"
...
const (
	AuditBackupCompleted       AuditAction = "BACKUP_COMPLETED"
	AuditBackupPartial         AuditAction = "BACKUP_PARTIAL"
	AuditBackupFailed          AuditAction = "BACKUP_FAILED"
	AuditBackupSnapshotDamaged AuditAction = "BACKUP_SNAPSHOT_DAMAGED"
)
