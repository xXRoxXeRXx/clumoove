...
export function TransferProgress({ progress, rate, transferred, remaining, labels }: TransferProgressProps) {
  return (
    <section className="ui-card flex flex-col p-6" aria-label={labels.progress}>
      ...
      <div className="ui-progress mb-6 h-5 border border-[var(--color-border)] p-0.5">
        <div className="h-full bg-[var(--color-bg-inverse)] transition-all duration-500 ease-out" style={{ width: `${progress}%` }} />
      </div>
