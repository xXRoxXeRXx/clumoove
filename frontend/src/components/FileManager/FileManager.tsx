          ...
          {!selectedProfile ? (
            ...
            <>
              {selectedEntries.length > 0 ? (
                <div
                  className="sticky top-16 lg:top-20 z-20 flex items-center justify-between gap-3 border-b border-[var(--color-border)] bg-[var(--color-bg-secondary)] px-3 py-2.5 rounded-t-[calc(var(--radius-lg,1rem)-1px)] shadow-xs relative"
                  role="toolbar"
                ...
                <div className="sticky top-16 lg:top-20 z-20 flex items-center justify-between gap-3 border-b border-[var(--color-border)] bg-[var(--color-bg-secondary)] p-3 rounded-t-[calc(var(--radius-lg,1rem)-1px)] shadow-xs">
