...
| `POST /files/profiles/{profileID}/entries:copy` | JWT | Copies one item with the same sealed-reference request shape; fallback copying streams via the API without disk retention. |
